...
_MEASUREMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030\034^[a-z][a-z0-9+.%~_-]{2,254}$')), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('Z\013measurement'))
_MEASUREMENT.fields_by_name['device_id'].has_options = True
_MEASUREMENT.fields_by_name['device_id']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\202\265\030\034^[a-z][a-z0-9+.%~_-]{2,254}$'))
